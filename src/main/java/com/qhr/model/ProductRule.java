...
public record ProductRule(
    ...
    //更新时间
    LocalDateTime updatedAt) implements Serializable, WithId<ProductRule> {

  @Override
  public ProductRule withId(Long id) {
    return new ProductRule(id, productId, ruleVersion, ruleName, isActive, effectiveStartTime,
        effectiveEndTime, remark, gsMinEstablishMonths, gsMinRegisteredCapital, gsMinPaidInCapital,
        gsMaxLegalRepChangeCount2y, gsMinLegalRepChangeGapMonths, gsMinLegalRepShareRatio,
        gsAllowLegalRepNoJointLiability, gsAllowShareholderReplaceJointLiability,
        gsMinShareholderReplaceShareRatio, taxMinTaxMonths12m, taxMinTaxMonths24m,
        taxMaxZeroDeclareStreak, taxMinTaxAmount12m, taxMinTaxAmountYtd, taxMinTaxAmountLastYear,
        taxMaxTaxBurdenRatio, taxMinTaxBurdenRatioYoy, taxMinTotalDeclares,
        judRejectIfMajorLawsuit, judRejectIfExecuted, judRejectIfDishonestPerson,
        judRejectIfEquityFrozen, judMaxExecutionCount24m, judMaxCourtAnnouncementCount12m,
        judMaxAdminPenaltyCount12m, judRejectIfMajorJudicialRisk,
        judRejectIfRestrictionHighConsumption, indMatchModeCode, indMaxRiskLevel,
        indRequireEnterpriseTag, indMinTagValidMonths, indRequireRegionMatch,
        indRequireActualBusinessAddress, indRejectIfHighPollution, indRejectIfHighEnergyConsumption,
        indRejectIfSensitiveIndustry, ecMaxTotalLiability, ecMaxCreditLiability,
        ecMaxMortgageLiability, ecMaxExternalGuaranteeAmount, ecMaxLoanOrgCount,
        ecMaxQueryCount6m, ecMaxOverdueCount12m, ecMaxOverdueMonths24m, ecMinNoOverdueDays,
        ecAllowAbnormalCreditAccount, pcMaxQueryCount1m, pcMaxQueryCount3m, pcMaxQueryCount6m,
        pcMaxLoanQueryCount1m, pcMaxCreditCardQueryCount1m, pcMaxOverdueCount12m,
        pcMaxOverdueMonths24m, pcMaxTotalOverdueTerms5y, pcMaxNonBankLoanCount,
        pcMaxCreditCardUtilization, extJson, createdAt, updatedAt);
  }
}
