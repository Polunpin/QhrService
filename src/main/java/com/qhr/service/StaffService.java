...
public interface StaffService {
  ...
  /** 根据ID查询员工 */
  com.qhr.model.Staff getById(Long id);

  /** 根据手机号查询员工 */
  com.qhr.model.Staff getByMobile(String mobile);

  /** 创建员工并返回主键 */
  Long create(com.qhr.model.Staff staff);

  /** 更新员工 */
  boolean update(com.qhr.model.Staff staff);
